...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-material focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--ring))] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
        ...
        destructive:
          "bg-[hsl(var(--destructive))] text-white hover:shadow-md",
        outline:
        ...
        tonal:
          "bg-[hsl(var(--accent))] text-[hsl(var(--primary))] hover:shadow-sm",
      },
      size: {
